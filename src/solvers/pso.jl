...
Algorithms for Optimization book.[^1]
...
- `Population`: can be any `AbstractArray` that contains [types.jl Particle](@ref)
instances, but it is expected to be generated by [types.jl Population](@ref).
