...
# Keyword arguments
_It is recommended to use the default values provided_
...
function PSO(f::Function, population::AbstractArray, k_max::Int;
    w=0.9, c1=2.0, c2=2.0)
    seed = RandomNumbers.gen_seed(UInt64)
...
```
"""
function PSO(f::Function, population::AbstractArray, k_max::T, seed::V;
...
```
"""
function PSO(f::TestFunctions, population::AbstractArray, k_max::T, seed::V;
    w=0.9, c1=2.0, c2=2.0) where {T<:Integer, V<:Integer}
...
function _create_rng(seed::Integer)
