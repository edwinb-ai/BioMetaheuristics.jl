...
In scientific computing, the [Julia programming language](julialang.org) has been an excellent tool to get rid of the
...
## The Evolutionary Computation Bestiary[^6]

There is a _hidden_ goal for `Newtman.jl` and that is to implement _all_ of the algorithms proposed in the
[EC Bestiary](https://github.com/fcampelo/EC-Bestiary), which is a compilation of most of the nature and bio-inspired algorithms
in the literature.
